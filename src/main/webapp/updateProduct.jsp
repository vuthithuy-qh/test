<%-- 
    Document   : update
    Created on : Jun 29, 2025, 1:14:23 PM
    Author     : nguye
--%>
...
<form action="ProductManagement" method="post">
    ...
    <div>
        ...
        <input type="text" name="importPrice"
               value="<%= car != null && car.getImportPrice() != null ? car.getImportPrice().toString() : "" %>"
    ...
    <div>
        ...
        <input type="text" name="sellingPrice"
               value="<%= car != null && car.getSellingPrice() != null ? car.getSellingPrice().toString() : "" %>"
    ...
    <div>
        ...
        <input type="date" name="importDate"
               value="<%= car != null && car.getImportDate() != null ? new java.text.SimpleDateFormat("yyyy-MM-dd").format(car.getImportDate()) : "" %>"
